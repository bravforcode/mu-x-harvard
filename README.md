...
![Harvard](https://img.shields.io/badge/Harvard-Health_Systems_Lab-A51C30?style=for-the-badge)
![Mahidol](https://img.shields.io/badge/Mahidol-University-2D7DD2?style=for-the-badge)
![Selected](https://img.shields.io/badge/Status-Selected_Participant_196_Teams-FFD700?style=for-the-badge)
...
```mermaid
graph LR
  A[Patient App] --> B[Wayfinding Engine]
  B --> C[Indoor Navigation]
  B --> D[Queue Optimization]
  D --> E[(Hospital Flow Data)]
```
